...
<body class="bg-gray-50">
   ...
   <div
      ...
      <div class="flex justify-between items-center">
         ...
         <button @click="show = false" class="text-green-700 hover:text-green-900 font-bold ml-4">×</button>
      </div>
   </div>
   @endif
   ...
   <div
      ...
      <div class="flex justify-between items-center">
         ...
         <button @click="show = false" class="text-red-700 hover:text-red-900 font-bold ml-4">×</button>
      </div>
   </div>
   @endif
   ...
   <div class="p-4 rounded-lg bg-red-50 text-red-800 border border-red-200 max-w-7xl mx-auto mt-6 px-6">
            ...
            <table class="min-w-full text-sm text-left">
               <thead>
                  <tr class="border-b border-gray-200">
                     ...
                     <th class="px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">Region</th>
                     <th class="px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">Roast</th>
                     <th class="px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">Type</th>
                     <th class="px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">Price</th>
                     <th class="px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">Inventory</th>
               ...
               <tbody class="divide-y divide-gray-100">
                  ...
                  <tr x-data="{ confirmDelete: false }" class="hover:bg-gray-50 transition-colors duration-100">
                     ...
                     {{-- PRICE --}}
                     <td class="px-4 py-3">
                        <form method="POST" action="{{ route('dashboard.updatePrice', $product) }}" class="flex gap-2 items-center">
                           @csrf
                           @method('PUT')
                           <input
                     ...
                     {{-- ACTIONS --}}
                     <td class="px-4 py-3">
                        <form method="POST" action="{{ route('dashboard.addInventory', $product) }}" class="flex gap-2 items-center mb-2">
                           @csrf
                           <input
                        ...
                        <div x-cloak x-show="confirmDelete" class="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
